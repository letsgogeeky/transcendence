...
_The goal of this project is to build a modern web platform for the **legendary Pong game** 🏓 — but with a twist: multiplayer, tournaments, chat, 3D graphics, and even AI opponents."_ 🚀

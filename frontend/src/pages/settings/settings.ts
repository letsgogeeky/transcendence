...
import { copyrightLine, loadImage } from '../../styles/background';
...
export default class UserSettingsComponent extends Component {
    ...
    render(parent: HTMLElement) {
        ...
        settingsHeader.className =
            'flex justify-center items-center w-full mt-16 mb-16'; // Added gap for spacing between icon and title
        ...
        settingsTitle.className =
            'font-black text-3xl px-8 py-4 text-black transition-all pointer-events-auto font-impact rounded-xl';
        ...
        sectionsContainer.className =
            'flex flex-wrap justify-center gap-28 w-full';
        ...
        const avatar = new AvatarImageComponent(
            ...
            user.avatarUrl!,
            null,
            'w-48 h-48 rounded-full object-cover border-2border-[#eedee5] shadow-lg',
        );
        ...
        const form = new FormComponent(
            'save info',
            [nameInput, emailInput, otpMethodInput],
